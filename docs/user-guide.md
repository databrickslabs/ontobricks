...
> | **On Databricks** | Over the limit, with `ONTOBRICKS_ANALYTICS_JOB_ENABLED=true` | The above **plus** PageRank, clustering coefficient and the component count exactly, and betweenness and closeness as estimates |
>
