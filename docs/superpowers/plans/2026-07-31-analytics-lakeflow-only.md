...
**Spec:** `docs/superpowers/specs/2026-07-31-analytics-lakeflow-only-design.md`
...
**Files:**
- Modify: `docs/` (the analytics page and any architecture page naming the three modes), `README.md`
