...
**Spec:** `docs/superpowers/specs/2026-08-03-github-pages-marketing-site-design.md`
...
- Do not move or delete `docs/` Markdown/Sphinx content; only stop using `/docs` as the Pages root.
...
**Interfaces:**
- Consumes: nested chrome; link out to GitHub `docs/get-started.md`
...
**Interfaces:**
- Produces: cards linking into GitHub Markdown under `docs/` — not Sphinx HTML
