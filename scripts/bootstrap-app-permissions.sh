...
#
# Usage:
#   scripts/bootstrap-app-permissions.sh                 # bootstrap both apps
#   scripts/bootstrap-app-permissions.sh ontobricks      # bootstrap a single app
...
DEFAULT_APPS=("ontobricks" "mcp-ontobricks")
